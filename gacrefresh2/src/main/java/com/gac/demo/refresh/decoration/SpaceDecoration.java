package com.gac.demo.refresh.decoration;
...
public class SpaceDecoration extends RecyclerView.ItemDecoration {
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
         ...
         * 普通Item的尺寸
         */
      //  L.d("EasyRecyclerView","position:"+position+" headerCount:"+headerCount + "  count:"+(parent.getAdapter().getItemCount()-footerCount));
        if ((position>=headerCount&&position<parent.getAdapter().getItemCount()-footerCount)) {
            ...
            if (orientation == VERTICAL) {
              ...
              //  L.d("EasyRecyclerView"," left:"+outRect.left+" right:"+outRect.right+" space:"+space);
