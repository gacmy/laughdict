package com.gac.laughdict.widget.statelayout;
...
import com.widget.dialog.ProgressWheel;
...
public class StateLayout extends FrameLayout {
    ...
    private void parseAttrs(Context context, AttributeSet attrs) {
        ...
        if (progressViewId != -1) {
            ...
            progressBar.setBarColor(getResources().getColor(R.color.main_color));
            //progressBar.setIndeterminateDrawable(getResources().getDrawable(R.drawable.main_progress_bar));
        ...
        errorView = inflater.inflate(R.layout.view_error_state, this, false);
        ...
        emptyView = inflater.inflate(R.layout.view_empty_state, this, false);
        ...
        if (emptyDrawable != null) {
            ...
            emptyImageView.setImageResource(R.mipmap.ic_empty_holder);
        }
        addView(emptyView);
        /******************************************************************************************/
    ...
    public void setStateClicListener(StateClickListener listener){
