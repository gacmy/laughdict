...
package com.gac.demo.refresh.adapter;
...
abstract public class RecyclerArrayAdapter<T> extends RecyclerView.Adapter<BaseViewHolder>   {
   ...
   // protected EventDelegate mEventDelegate;
    ...
    //public List<Boolean> isClick = new ArrayList<>();
...
//            mEventDelegate.setLoadMore(isLoadMore);
//        }
//    }
    /**
        ...
        if (mItemClickListener!=null) {
            viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                   // Log.d("RecyclerArrayAdapter","item click position:"+(viewHolder.getAdapterPosition()-headers.size()));
                    mItemClickListener.onItemClick(viewHolder.getAdapterPosition()-headers.size());
//                    for(int i = 0; i <isClick.size();i++){
//                        isClick.set(i,false);
//                    }
//                    isClick.set(viewHolder.getAdapterPosition()-headers.size(),true);
                    //notifyDataSetChanged();
    ...
    public void OnBindViewHolder(BaseViewHolder holder, final int position){
      //  L.d("RecyclerArrayAdapter","onBindViewHolder"+position);
